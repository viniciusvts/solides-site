...
<div class="lpPerfilDisc">
      ...
      <ul class="navbar-nav mr-auto">
        <li class="nav-item">
          <a @click="togleConteudo" class="nav-link" href="#">
            Conteúdo
            <img 
            v-if="controls.expandConteudo" 
            class="submenu" 
            src="@/assets/img/seta-pra-cima.png" 
            alt="menu">
            <img v-else class="submenu" src="@/assets/img/seta-pra-baixo.png" alt="menu">
          </a>
          <div
  ...
  <div class="container over-x-h mt-70 pb-60">
    <div class="row ml-0">
    ...
    <div class="centerize-itens mt-70">
      <a href="#">
        <button class="badge badge-pill mx-button blue-back">Comprar Agora</button>
      </a>
      <a href="#">
        <button class="badge badge-pill mx-button blue-outline">Fale com um especialista</button>
      </a>
    </div>
  </div>
  <div class="container over-x-h pt-60 pb-60 text-center">
  ...
  <div class="container over-x-h pt-60 text-center bg-light">
  ...
  <div class="container over-x-h pb-60">
    <div class="row ml-0">
      <div class="to-left-30">
        <div class="vertical-pill cyan"></div>
        <img src="@/assets/img/Terceira-sessao-perfil-disc 2.png" alt="homem achando solução na solides">
      </div>
      <div class="text-left to-right-70 mt-30">
        <h2>Como o Profiler tem ajudado pessoas e empresas?</h2>
      </div>
    </div>
  </div>
  <div class="container over-x-h">
  ...
  <div class="container over-x-h pt-60 pb-60">
  ...
  <!-- <img class="w-100" src="@/assets/img/frame1.png" alt=""> -->
  <div class="container over-x-h pt-60">
  ...
  <img class="w-100 rotate-180" src="@/assets/img/frame1.png" alt="">
  <div class="container over-x-h bg-light">
  ...
  <img class="w-100" src="@/assets/img/frame1.png" alt="">
  <div class="container over-x-h pb-60 text-center">
    <div class="container">
      <h2 class="color-primary">Compre Agora mesmo e receba os créditos para usar o Profiler hoje mesmo</h2>
      <p class="mt-4 mb-4"><span class="color-cyan bold">R$ 69,90 por crédito</span></p>
  ...
  <!-- form aqui -->
  <div class="container over-x-h pt-60 pb-60 bg-gray">
    <h2>Form Aqui!</h2>
  </div>
  <div class="container over-x-h pt-60 pb-60">
    <div class="row ml-0">
...
<style lang="scss">
    @import '@/assets/scss/lpPerfilDisc.scss';
</style>
