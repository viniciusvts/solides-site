<template>
  <div class="avaliacao-desempenho-B">
    <div class="container">
      <div class="row">
        <div class="col-12 col-lg-6 text-center text-lg-right vertical-center">
          <h2 v-html="data.titulo"></h2>
          <img v-lazy="data.imagem.url" :alt="data.imagem.alt" class="img-mobile d-lg-none">
...
<style lang="scss">
    @import '@/assets/scss/avaliacao-desempenho_B.scss';
</style>
