        ...
        <div class="col-10 mx-auto row modal-out col-lg-6">
          ...
          @submit.prevent="sendForm">
            <div class="col-12 col-lg-11 mx-auto row">
              ...
              <input type="hidden" name="faturamentoAnual" v-model="form.faturamentoAnual">
              <input type="hidden" name="qtde_de_colaboradores" v-model="form.qtde_de_colaboradores">
              <input type="hidden" name="custo_de_produtividade" v-model="form.custo_de_produtividade">
...
<script>
export default {
  name: "RecebaSeuRelatorio-produtividade",
  data () {
    return {
  ...
  props: {
   ...
   mounted () {
    ...
    this.form.custo_de_produtividade = this.custoProd
    this.form.taxa_de_rotatividade = this.txRot
    this.form.faturamentoAnual = this.fatAno
  },
  methods: {
    removeHash(){
