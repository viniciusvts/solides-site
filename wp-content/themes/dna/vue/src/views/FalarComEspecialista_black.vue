...
<div style="background-color: black;">
  <div v-if="pageData" class="falar-com-um-especialista-black container">
    <div class="row">
      <div class="col-12 col-lg-6">
        <h1 v-html="pageData.acf.detalhe"></h1>
        ...
        <h3 class="d-none d-lg-block" v-html="pageData.acf.sub"></h3>
      </div>
      <div class="col-12 col-lg-6">
        <div class="black-img">
          <img src="@/assets/img/black_november.png" alt="Black November" srcset="">
        </div>
...
export default {
  ...
  mounted () {
    this.getPost();
    this.startHsForm('#hsform-falarcomespecialista');
  },
  methods: {
    getPost () {
    ...
    startHsForm (selector) {
      setTimeout(() => {
        window.hbspt.forms.create({
          portalId: "6009739",
          formId: "cee7e032-0d23-4ccc-811d-e6b5031d1df6",
          target: selector
        });
        setTimeout(()=>{
...
<style lang="scss">
  @import '@/assets/scss/falar-com-um-especialista-black.scss';
</style>
